...
const Question = _1.sequelize.define('Question', {
    ...
    answer: { type: sequelize_1.DataTypes.STRING, allowNull: false, validate: { notNull: { msg: 'answer is required' } } },
    SubjectId: { type: sequelize_1.DataTypes.INTEGER, allowNull: false, validate: { notNull: { msg: 'subjectId is required' } } },
